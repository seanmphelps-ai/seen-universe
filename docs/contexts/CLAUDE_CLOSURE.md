...
Entry → interaction mode → Person A Foundation → Person B Foundation → relationship/event context → independent calculations → comparative Helix → three shadow cards → selection → result → Cadence.
