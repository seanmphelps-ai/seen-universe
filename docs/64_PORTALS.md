...
- **WHAT** — the archetypal function, what it protects, creates, avoids, repairs, controls, understands, expresses, defends, or transforms.
- **WHEN** — when it becomes sensitive, reactive, available, or dangerous.
- **WHERE** — where in the person's life it lives — which environments, relationships, or life sections activate it.
- **HOW** — how it expresses when regulated, threatened, overloaded, or collapsed.
- **WHY** — why the system uses this response, what it protects, what need or fear drives it.
...
## 07 — THE ARMY
Discipline, collective action, the power of organized force. When pressured: rigidity, authoritarianism, control disguised as leadership. When collapsed: the person refuses all structure and calls it freedom.

## 08 — HOLDING TOGETHER
Unity, the bonds that hold people together. When pressured: codependence, loyalty that becomes a cage, the inability to leave a dying bond. When collapsed: the person isolates completely and calls it self-sufficiency.

## 09 — THE TAMING POWER OF THE SMALL
Attention to detail, the power of small consistent actions. When pressured: obsession with minutiae that avoids the real issue. When collapsed: the person ignores all details and calls it big-picture thinking.

## 10 — TREADING
Careful conduct, walking the line. When pressured: hypervigilance, walking on eggshells, the constant monitoring of others' reactions. When collapsed: the person stops caring about consequences and calls it authenticity.
...
Abundance, the holding of resources. When pressured: hoarding, the fear of loss that turns abundance into scarcity. When collapsed: the person gives everything away and calls it generosity.

## 15 — MODESTY
Humility, the absence of false elevation. When pressured: self-deprecation, the hiding of real gifts to avoid exposure. When collapsed: the person inflates and calls it confidence.

## 16 — ENTHUSIASM
Inspiration, the spark that moves people. When pressured: mania, the inability to sustain, the crash after the high. When collapsed: the person becomes cynical and calls it realism.
...
## 23 — SPLITTING APART
Decay, the falling away of structure. When pressured: collapse, the sense that everything is falling apart. When collapsed: the person clings to what is dying and calls it loyalty.

## 24 — RETURN
The turning point, the return to source. When pressured: regression, the retreat to old patterns under stress. When collapsed: the person refuses to return and calls it growth.
...
Excessive burden, the weight that is too much. When pressured: overwhelm, the sense that everything is too heavy. When collapsed: the person drops everything and calls it release.

## 29 — THE ABYSMAL
Danger, the repeated fall into the same pit. When pressured: self-destruction, the compulsion to repeat the dangerous pattern. When collapsed: the person avoids all risk and calls it safety.

## 30 — THE CLINGING, FIRE
Dependence, the attachment to what illuminates. When pressured: obsession, the inability to let go of what gives light. When collapsed: the person extinguishes all light and calls it independence.

## 31 — INFLUENCE
Attraction, the power to move others. When pressured: manipulation, the use of charm to control. When collapsed: the person withdraws all influence and calls it humility.
...
The suppression of truth, the hiding of what is real. When pressured: secrecy, the concealment of self to survive. When collapsed: the person exposes everything recklessly and calls it honesty.

## 37 — THE FAMILY
The domestic bond, the structure of belonging. When pressured: enmeshment, the loss of self in the family system. When collapsed: the person rejects all family and calls it freedom.
...
The assembly, the power of the group. When pressured: exploitation, the use of collective power for personal gain. When collapsed: the person rejects all groups and calls it individuality.
...
Subordination, the entering into a lesser position. When pressured: manipulation, the use of subservience to gain power indirectly. When collapsed: the person refuses all partnership and calls it independence.
...
## 58 — THE JOYOUS
Pleasure, the capacity for joy. When pressured: addiction, the pursuit of pleasure that becomes compulsion. When collapsed: the person rejects all pleasure and calls it discipline.
